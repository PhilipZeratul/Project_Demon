...
namespace TriangulationMethods
{
    ...
    {
        public static List<Vertex> JarvisMarch(List<Vertex> points)
        {
            ...
            while (true)
            {
                ...
                Vector2 a = currentPoint.GetPos2D();

                Vector2 b = nextPoint.GetPos2D();
